 ...
 * using the standard Btcnano protocol. A Peer instance represents one connection
 * on the Btcnano network. To create a new peer connection provide the host and port
